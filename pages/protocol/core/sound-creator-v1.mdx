...
1. Deploys a minimal proxy of [SoundEditionV1](/protocol/core/sound-edition-v1) to a deterministic address with a `salt`, and calls its [`initialize`](/protocol/core/sound-edition-v1#initialize) function with the provided `initData` calldata.
