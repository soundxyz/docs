...
You can also visit our [github.com/soundxyz example](https://github.com/soundxyz/sdk/tree/main/example/src) which contains more comprehensive examples on how you can interact with the Sound SDK

### Editions

Please check [https://docs.sound.xyz/sdk/edition](https://docs.sound.xyz/sdk/edition) for information on how to use the SDK with different type editions contracts of Sound.xyz
